...
perform_rmd_checks $base_pth/lab2.rmd $base_pth/lab2.Rmd
perform_rmd_checks $base_pth/lab2_blind.rmd $base_pth/lab2_blind.Rmd
...
perform_check_file $base_pth/lab2.pdf
perform_check_file $base_pth/lab2_blind.pdf
