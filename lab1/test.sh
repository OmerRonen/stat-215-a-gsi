...
perform_rmd_checks $base_pth/lab1.rmd $base_pth/lab1.Rmd
perform_rmd_checks $base_pth/lab1_blind.rmd $base_pth/lab1_blind.Rmd
...
perform_check_file $base_pth/lab1.pdf
perform_check_file $base_pth/lab1_blind.pdf
